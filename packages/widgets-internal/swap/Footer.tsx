...
import { LinkExternal, Flex, Svg, Image, Button } from "@cometswap/uikit";
...
> = ({
  ...
  externalText,
  externalLinkUrl,
  helpImage = <Image src="https://cdn.cometswap.com/help/help.png" alt="Get some help" width={160} height={108} />,
}) => {
