import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@cometswap/sdk'
import {
  BaseRoute,
  RouteType,
  SmartRouter,
...
import { CometSwapOptions } from '../types'

// Wrapper for cometswap router-sdk trade entity to encode swaps for Universal Router
export class CometSwapTrade implements Command {
  readonly tradeType: RouterTradeType = RouterTradeType.CometSwapTrade

  readonly type: TradeType

  constructor(public trade: Omit<SmartRouterTrade<TradeType>, 'gasEstimate'>, public options: CometSwapOptions) {
