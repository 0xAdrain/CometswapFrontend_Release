...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from '@cometswap/swap-sdk-core'
...
/**
 * Represents the Comet V3 QuoterV1 contract with a method for returning the formatted
