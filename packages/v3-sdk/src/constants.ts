...
export const FACTORY_ADDRESSES = {
  ...
  [ChainId.BASE_SEPOLIA]: '0x618f16159d489AA7761168F0200b7705dee9e2C0', // Using same as BASE_TESTNET for now
  [ChainId.ARBITRUM_SEPOLIA]: FACTORY_ADDRESS, // Using same as ARBITRUM_ONE for now
  ...
  [ChainId.XLAYER_TESTNET]: '0x455726A6286965D92F380106A5297942ECAD9278',
...
export const DEPLOYER_ADDRESSES = {
  ...
  [ChainId.BASE_SEPOLIA]: '0x5A6919Dfd2C761788608b0D1bd1239961ADCB08B', // Using same as BASE_TESTNET for now
  [ChainId.ARBITRUM_SEPOLIA]: '0xbC465fbf687e4184103b67Ed86557A8155FA4343', // Using same as ARBITRUM_GOERLI for now
  [ChainId.SCROLL_SEPOLIA]: '0x623A2334F7f062a49785191244f775191248721c',
  [ChainId.SEPOLIA]: '0x13A042B3F02434E72F2936a2879F4a2D342D8aD6',
  [ChainId.XLAYER_TESTNET]: '0xDFAFd745c5Dd83a96CeAAD41a2fC22272A8A2538',
} as const satisfies Record<ChainId, Address>

export const ADDRESS_ZERO = '0x0000000000000000000000000000000000000000'

const POOL_INIT_CODE_HASH = '0x6ce8eb472fa82df5469c6ab6d485f17c3ad13c8cd7af59b3d4a8026c5ce0f7e2'
const XLAYER_TESTNET_POOL_INIT_CODE_HASH = '0x80c198c5f9301734f2dccabbd3461c79fc1dec8eeeb2acc6e44baec0532a7f64'
...
export const POOL_INIT_CODE_HASHES = {
  ...
  [ChainId.XLAYER_TESTNET]: XLAYER_TESTNET_POOL_INIT_CODE_HASH,
...
export const NFT_POSITION_MANAGER_ADDRESSES = {
  ...
  [ChainId.XLAYER_TESTNET]: '0xc278410e8A8cdc4501e0FDE7B45B397C9c46E4ED',
} as const satisfies Record<ChainId, Address>
