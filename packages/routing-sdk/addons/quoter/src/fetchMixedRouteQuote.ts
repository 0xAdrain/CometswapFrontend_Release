import { StablePool, isStablePool } from '@cometswap/routing-sdk-addon-stable-swap'
import { V2Pool, isV2Pool } from '@cometswap/routing-sdk-addon-v2'
import { V3Pool, isV3Pool } from '@cometswap/routing-sdk-addon-v3'
