export const iveCometABI = [
  {
    inputs: [{ internalType: 'address', name: '_vecometAddress', type: 'address' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: 'VEveCometUser', type: 'address' },
    ],
    name: 'Approve',
    type: 'event',
  },
  ...
  {
    inputs: [{ internalType: 'address', name: '_VEveCometUser', type: 'address' }],
    name: 'approveToVEveCometUser',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      {
        components: [
          { internalType: 'address', name: 'VEveCometUser', type: 'address' },
          { internalType: 'address', name: 'delegator', type: 'address' },
        ],
        internalType: 'struct IveCometV3.DelegatorConfig[]',
