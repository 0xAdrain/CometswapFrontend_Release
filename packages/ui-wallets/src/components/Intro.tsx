...
import { AtomBox, Button, Heading, Image, LinkExternal, Text } from '@cometswap/uikit'
...
const IntroSteps = [
  {
    ...
    icon: 'https://cdn.cometswap.com/wallets/wallet_intro.png',
    description: (
      <Trans>
  ...
  },
  {
    ...
    icon: 'https://cdn.cometswap.com/wallets/world_lock.png',
    description: (
      <Trans>
