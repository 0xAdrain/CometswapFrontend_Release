...
export const cometProtectors: GameType = {
  id: 'comet-protectors',
  projectName: 'Mobox',
    ...
    items: [
      {
        ...
        video: 'https://www.mobox.io/download/Comet_Protectors_Video.mp4',
        image: 'https://cometprotectors.io/assets/cometswap-game-landing/5.png',
      },
      {
  ...
  playlist: [
    {
      videoId: '80j7QpNqKcI',
      title: 'Unleashing the Power of Comet Protectors: A Web3 Gaming Adventure on CometSwap',
    },
    {
      videoId: '--UcFQ64sjY',
