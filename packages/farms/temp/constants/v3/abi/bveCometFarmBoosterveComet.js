...
exports.bveCometFarmBoosterveCometABI = void 0;
exports.bveCometFarmBoosterveCometABI = [
    {
        inputs: [
            { internalType: 'address', name: '_VEveComet', type: 'address' },
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'address', name: 'VEveCometCaller', type: 'address' }],
        name: 'UpdateVEveCometCaller',
        type: 'event',
    },
    {
        inputs: [],
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'bool', name: '_isCometPoolUser', type: 'bool' },
        ],
        name: 'depositFor',
        outputs: [],
        stateMutability: 'nonpayable',
    ...
    {
        inputs: [{ internalType: 'address', name: '_VEveCometCaller', type: 'address' }],
        name: 'setVEveCometCaller',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    },
