import { Currency, CurrencyAmount, Pair, ZERO } from '@cometswap/sdk'
import { Pool as V3Pool, TickList } from '@cometswap/v3-sdk'
import { getQuoteExactIn, getQuoteExactOut } from '@cometswap/stable-swap-sdk'
import {
  Pool as IPool,
  Pool,
  QuoteProvider,
