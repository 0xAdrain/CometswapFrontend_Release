...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.XLAYER_TESTNET]: '0xeA613C8606E60111D6c2f94e128717B1300D2dc9',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.XLAYER_TESTNET]: '0x7995AF9CCd82DB9177C62D687681D1093Aa025A0',
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.XLAYER_TESTNET]: '0x0b08C0D20688C8ED59dfF544B72abd582327D14A',
} as const satisfies Record<ChainId, Address>
