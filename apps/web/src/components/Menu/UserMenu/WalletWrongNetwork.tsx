...
import { Button, Text, Link, HelpIcon, Message, MessageText } from '@cometswap/uikit'
...
const WalletWrongNetwork: React.FC<React.PropsWithChildren<WalletWrongNetworkProps>> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <StyledLink href="https://docs.cometswap.finance/get-started/connection-guide" external>
