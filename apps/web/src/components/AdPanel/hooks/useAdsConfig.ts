  ...
  const configPerp: AdsCampaignConfig = {
    ...
    ad: {
      ...
      texts: [
        ...
        {
          text: t('Trade Now'),
          link: 'https://perp.cometswap.finance/en/futures/v2/BTCUSD',
        },
      ],
      btn: {
        text: t('Learn More'),
        link: 'https://blog.cometswap.finance/articles/trade-tst-trump-pepe-and-more-tokens-on-comet-swap-perpetual-v2-on-chain-and-share-a-10-000-prize-pool?utm_source=Website&utm_medium=SwapPage&utm_campaign=Perps&utm_id=PerpsCampaign',
      },
      options: {
        imagePadding: '20px',
      },
