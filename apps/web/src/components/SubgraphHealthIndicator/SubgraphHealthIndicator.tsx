import { useTranslation, TranslateFunction } from '@cometswap/localization'
import { styled } from 'styled-components'
import { Card, Flex, Box, InfoIcon, Text, useTooltip } from '@cometswap/uikit'
...
import { AVERAGE_CHAIN_BLOCK_TIMES, ChainId, chainNames, getChainName } from '@cometswap/chains'
