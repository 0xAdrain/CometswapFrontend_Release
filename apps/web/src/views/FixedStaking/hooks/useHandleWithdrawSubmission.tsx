...
import { Link, useToast } from '@cometswap/uikit'
  ...
  const throwCustomError = useCallback(() => {
    toastInfo(
      ...
      <>
        ...
        <Link
          external
          href="https://docs.cometswap.finance/products/simple-staking/faq#what-happens-in-the-withdrawal-process-when-withdrawal-approval-is-pending"
        >
          {t('Learn more')}
        </Link>
      </>,
