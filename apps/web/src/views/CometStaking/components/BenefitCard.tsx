...
import { Button, Card, Flex, FlexGap, Heading, Text } from '@cometswap/uikit'
import { NextLinkFromReactRouter } from '@cometswap/widgets-internal'
import styled from 'styled-components'

type BenefitCardType = 'earnComet' | 'gaugesVoting' | 'farmBoost' | 'snapshotVoting' | 'ifo' | 'more' | 'crossChain'
...
export const BENEFITS: Record<BenefitCardType, BenefitItem> = {
  crossChain: {
    headImg: '/images/comet-staking/cross-chain.png',
    title: <Trans>veCOMETSync</Trans>,
    subTitle: <Trans>Number of Chains with veCOMET</Trans>,
    btnText: <Trans>View Details</Trans>,
    desc: [
      <Trans>Enjoy the same veCOMETbenefits on other networks.</Trans>,
      <Trans>Explorer other CometSwap benefits.</Trans>,
    ],
    key: 'cross-chain-Comet',
  },
  earnComet: {
    headImg: '/images/comet-staking/benefit-earn-comet.png',
    title: <Trans>Earn COMET</Trans>,
    subTitle: <Trans>Total Distributed</Trans>,
    btnText: <Trans>Check Reward</Trans>,
    desc: [<Trans>Weekly revenue sharing</Trans>, <Trans>Weekly COMETpool rewards</Trans>],
    key: 'benefit-earn-comet',
  },
  gaugesVoting: {
    headImg: '/images/comet-staking/benefit-gauges-voting.png',
  ...
  farmBoost: {
    headImg: '/images/comet-staking/benefit-farm-boost.png',
  ...
  snapshotVoting: {
    headImg: '/images/comet-staking/benefit-snapshot-voting.png',
    title: <Trans>Snapshot Voting</Trans>,
    subTitle: <Trans>Number of Proposals</Trans>,
    btnText: <Trans>Check Snapshot Voting</Trans>,
    link: '/voting',
    desc: [<Trans>Use your veCOMETto vote on important governance proposals</Trans>],
    key: 'benefit-snapshot-voting',
  },
  ifo: {
    headImg: '/images/comet-staking/benefit-ifo.png',
  ...
  more: {
    headImg: '/images/comet-staking/benefit-more.png',
    ...
    link: 'https://docs.cometswap.finance/products',
    key: 'benefit-more',
  },
}
    ...
    <StyledCard innerCardProps={{ p: ['16px', '16px', '24px'] }}>
      <FlexGap flexDirection="column" gap="16px" height="100%" justifyContent="space-between">
        <FlexGap gap="16px" alignItems="center">
          <HeadImage>
            <img srcSet={`${info.headImg} 2x`} alt="earn-comet" />
          </HeadImage>
