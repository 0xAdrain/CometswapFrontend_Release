import { ERC20Token, CurrencyAmount } from '@cometswap/sdk'
...
describe('limitOrders/utils/getPriceForOneToken', () => {
  describe.each([
    [CurrencyAmount.fromRawAmount(COMET, ONE), CurrencyAmount.fromRawAmount(BUSD, ONE), '1'],
    [CurrencyAmount.fromRawAmount(COMET, FIVE), CurrencyAmount.fromRawAmount(BUSD, FIVE), '1'],
    [CurrencyAmount.fromRawAmount(COMET, ONE), CurrencyAmount.fromRawAmount(BUSD, FIVE), '5'],
    [CurrencyAmount.fromRawAmount(COMET, FIVE), CurrencyAmount.fromRawAmount(BUSD, ONE), '0.2'],
    ...
    [CurrencyAmount.fromRawAmount(COMET, ZERO), CurrencyAmount.fromRawAmount(BUSD, ONE), undefined],
    [CurrencyAmount.fromRawAmount(COMET, ONE), CurrencyAmount.fromRawAmount(BUSD, ZERO), undefined],
