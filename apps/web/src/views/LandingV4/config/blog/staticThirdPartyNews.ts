...
export const staticThirdPartyNews: V4ArticleDataType[] = [
  {
    ...
    description:
      'CometSwap is the official partner of ETHGlobal London 2024. Hosting our first-ever hackathon featuring a $10,000 prize pool, where developers can showcase their creativity by building innovative hooks and win rewards.',
    createAt: '2024-03-15',
    categories: [],
    content: '',
    gamesCategories: [],
    ...
    newsOutBoundLink: 'https://ethglobal.com/events/london2024/prizes/cometswap',
  ...
  },
  {
    ...
    title: 'ETHBrussels',
    description:
      'CometSwap is the official partner of ETHGlobal Brussel 2024, hosting a hackathon with $20,000 in prizes.',
    createAt: '2024-07-1',
    categories: [],
    content: '',
    gamesCategories: [],
    ...
    locale: 'en',
    newsFromPlatform: 'ETHGlobal',
    newsOutBoundLink: 'https://ethglobal.com/events/brussels/prizes/cometswap',
