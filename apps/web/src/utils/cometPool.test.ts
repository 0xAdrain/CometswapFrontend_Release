import { BOOST_WEIGHT, DURATION_FACTOR, MAX_LOCK_DURATION, UNLOCK_FREE_DURATION } from '@cometswap/pools'
import BigNumber from 'bignumber.js'
import dayjs from 'dayjs'
import { describe, it, vi } from 'vitest'
import { VaultPosition, getVaultPosition } from './cometPool'
import { getveCometVaultV2Contract } from './contractHelpers'

describe.concurrent('cometPool', () => {
  it.each([
    ...
    const cakeVault = getveCometVaultV2Contract()
