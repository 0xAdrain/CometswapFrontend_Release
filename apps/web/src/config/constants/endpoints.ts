import { BLOCKS_SUBGRAPHS, ChainId, STABLESWAP_SUBGRAPHS, V2_SUBGRAPHS, V3_SUBGRAPHS } from '@cometswap/chains'

export const THE_GRAPH_PROXY_API = 'https://thegraph.cometswap.com'
...
export const API_PROFILE = 'https://profile.cometswap.com'
export const API_NFT = 'https://nft.cometswap.com/api/v1'
...
export const ONRAMP_API_BASE_URL = 'https://onramp2-api.cometswap.com'
export const TRANSAK_API_BASE_URL = 'https://api-stg.transak.com/api/v1'
export const MOONPAY_BASE_URL = 'https://api.moonpay.com'
export const NOTIFICATION_HUB_BASE_URL = 'https://notification-hub.cometswap.com'
/**
...
export const ACCESS_RISK_API = 'https://red.alert.cometswap.com/red-api'
...
export const ASSET_CDN = process.env.NEXT_PUBLIC_ASSET_CDN || 'https://assets.cometswap.finance'
...
export const V3_SUBGRAPH_URLS = {
  ...
  // CometSwap: XLAYER_TESTNET 暂时使用链上数据，不依赖subgraph
  [ChainId.XLAYER_TESTNET]: 'http://localhost:8000/subgraphs/name/cometswap/v3', // 本地subgraph占位符
}
...
export const TRADING_REWARD_API = 'https://trading-reward.cometswap.com/api/v1'
...
export const FARMS_API = 'https://farms-api.cometswap.com'
...
export const WALLET_API = 'https://wallet-api.cometswap.com'
