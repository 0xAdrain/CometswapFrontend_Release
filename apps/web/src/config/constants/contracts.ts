...
import { GAUGES_ADDRESS, GAUGES_CALC_ADDRESS } from '@cometswap/gauges'
import { ICOMET} from '@cometswap/ifos'
import { COMET_VAULT } from '@cometswap/pools'
import { V3_QUOTER_ADDRESSES } from '@cometswap/smart-router'
import { DEPLOYER_ADDRESSES, NFT_POSITION_MANAGER_ADDRESSES } from '@cometswap/v3-sdk'
...
export default {
  ...
  multiCall: {
    ...
    [ChainId.XLAYER_TESTNET]: '0xcA11bde05977b3631167028862bE2a173976CA11',
  },
  cometProfile: {
  ...
  cometVault: COMET_VAULT,
  cometFlexibleSideVault: {
