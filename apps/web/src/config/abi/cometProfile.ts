export const cometProfileABI = [
  {
    inputs: [
      { internalType: 'contract IBEP20', name: '_cakeToken', type: 'address' },
      { internalType: 'uint256', name: '_numberveCometToReactivate', type: 'uint256' },
      { internalType: 'uint256', name: '_numberveCometToRegister', type: 'uint256' },
      { internalType: 'uint256', name: '_numberveCometToUpdate', type: 'uint256' },
    ],
  ...
  {
    inputs: [],
    name: 'numberveCometToReactivate',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_newNumberveCometToReactivate', type: 'uint256' },
      { internalType: 'uint256', name: '_newNumberveCometToRegister', type: 'uint256' },
      { internalType: 'uint256', name: '_newNumberveCometToUpdate', type: 'uint256' },
    ],
    name: 'updateNumberveComet',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
